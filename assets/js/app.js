    ...
    <div class="detail-grid">
      <div class="detail-main">
        <div class="detail-panel">
          ...
          <div class="fid-note">
            <div class="t">You stay the licensed advisor.</div>
            <p>${emp.fiduciary}</p>
          </div>
        </div>
      </div>
...
function route() {
  ...
  if (emp) {
    ...
    document.title = `${emp.name} — ${emp.role} · The Insurance Agent's AIME`;
  } else {
    detailEl.classList.remove('active');
    detailEl.innerHTML = '';
    galleryWrap.style.display = 'block';
    document.title = "AI Employees · The Insurance Agent's AIME";
  }
}
